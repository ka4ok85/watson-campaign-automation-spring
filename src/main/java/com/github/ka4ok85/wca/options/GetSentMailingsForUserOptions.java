...
public class GetSentMailingsForUserOptions extends AbstractOptions {
	...
	public GetSentMailingsForUserOptions(DateTimeRange dateTimeRange) {
		super();
	...
	public String toString() {
		return "GetSentMailingsForUserOptions [dateTimeRange=" + dateTimeRange + ", visibility=" + visibility
				...
				+ mailingCountOnly + ", excludeTestMailings=" + excludeTestMailings + ", optionalUser=" + optionalUser
				+ "]";
	}
