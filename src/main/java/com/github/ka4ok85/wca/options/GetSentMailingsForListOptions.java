...
public class GetSentMailingsForListOptions extends AbstractOptions {
	...
	public String toString() {
		return "GetSentMailingsForListOptions [listId=" + listId + ", dateTimeRange=" + dateTimeRange
				+ ", includeChildren=" + includeChildren + ", visibility=" + visibility + ", scheduled=" + scheduled
				+ ", send=" + send + ", sending=" + sending + ", optinConfirmation=" + optinConfirmation
				+ ", profileConfirmation=" + profileConfirmation + ", automated=" + automated + ", campaignActive="
				+ campaignActive + ", campaignCompleted=" + campaignCompleted + ", campaignCancelled="
				+ campaignCancelled + ", campaignScrapeTemplate=" + campaignScrapeTemplate + ", includeTags="
				+ includeTags + ", excludeZeroSent=" + excludeZeroSent + ", mailingCountOnly=" + mailingCountOnly
				+ ", excludeTestMailings=" + excludeTestMailings + "]";
	}
