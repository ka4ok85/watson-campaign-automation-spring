...
public class GetAggregateTrackingForUserOptions extends AbstractOptions {
	...
	public String toString() {
		return "GetAggregateTrackingForUserOptions [dateTimeRange=" + dateTimeRange + ", optionalUser=" + optionalUser
				+ ", visibility=" + visibility + ", scheduled=" + scheduled + ", sent=" + sent + ", sending=" + sending
				+ ", optinConfirmation=" + optinConfirmation + ", profileConfirmation=" + profileConfirmation
				+ ", automated=" + automated + ", campaignActive=" + campaignActive + ", campaignCompleted="
				+ campaignCompleted + ", campaignCancelled=" + campaignCancelled + ", topDomain=" + topDomain
				+ ", inboxMonitoring=" + inboxMonitoring + ", perClick=" + perClick + ", excludeTestMailings="
				+ excludeTestMailings + "]";
	}
