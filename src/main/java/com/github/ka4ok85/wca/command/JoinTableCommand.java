...
/**
 * <strong>Class for interacting with WCA JoinTable API.</strong> It builds XML
 * request for JoinTable API using
 * {@link com.github.ka4ok85.wca.options.JoinTableOptions} and reads response
 * into {@link com.github.ka4ok85.wca.response.JoinTableResponse}.
 * <p>
...
public class JoinTableCommand extends AbstractJobCommand<JoinTableResponse, JoinTableOptions> {
	...
	/**
	 * Builds XML request for JoinTable API using
	 * {@link com.github.ka4ok85.wca.options.JoinTableOptions}
	 * 
	 * @param options
	...
	/**
	 * Reads JoinTable API response into
	 * {@link com.github.ka4ok85.wca.response.JoinTableResponse}
	 * 
	 * @param jobPollingContainer
	 *            - raw POJO response for Schedule a Job API
	 * @param jobResponse
	 *            - raw POJO response for JoinTable API
	 * @param options
	 *            - settings for API call
	 * @return POJO Join Table Response
	 */
	@Override
