...
public enum ListColumnType {
	TEXT(0), YESNO(1), NUMERIC(2), DATE(3), TIME(4), COUNTRY(5), SELECTION(6), EMAIL(7), SEGMENTING(8), SYSTEM(
			9), SMS_OPT_IN(13), SMS_OPTED_OUT_DATE(
					14), SMS_PHONE_NUMBER(15), PHONE_NUMBER(16), TIMESTAMP(17), SYNC_ID(19), MULTI_SELECT(20);
