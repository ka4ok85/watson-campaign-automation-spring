...
@Component
@Scope("prototype")
public class GetAggregateTrackingForOrgResponse extends AbstractResponse {
	...
	public String toString() {
		return "GetAggregateTrackingForOrgResponse [clicks=" + clicks + ", inboxMonitorings=" + inboxMonitorings
