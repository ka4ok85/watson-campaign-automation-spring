...
public class ImportListResponse extends AbstractResponse {
	...
	public String toString() {
		return "ImportListResponse [description=" + description + ", badRecordsNumber=" + badRecordsNumber
				+ ", totalValidNumber=" + totalValidNumber + ", notAllowedNumber=" + notAllowedNumber
