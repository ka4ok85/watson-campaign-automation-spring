...
public class GetSentMailingsForOrgCommandTest {
	...
	private String defaultRequest = String.join(System.getProperty("line.separator"),
			...
			"<GetSentMailingsForOrg>", "<DATE_START>05/01/2017 00:00:00</DATE_START>",
			"<DATE_END>05/01/2018 00:00:00</DATE_END>", "</GetSentMailingsForOrg>", "</Body>", "</Envelope>");

	public GetSentMailingsForOrgCommandTest(String xmlNodeName, String methodName) {
	...
	public void testBuildXmlDoesNotAcceptNullOptions() {
		...
		GetSentMailingsForOrgOptions options = null;
	...
	public void testBuildXmlDefaultRequest() {
		...
		GetSentMailingsForOrgOptions options = new GetSentMailingsForOrgOptions(dateTimeRange);
	...
	public void testReadResponse()
		...
		GetSentMailingsForOrgCommand command = context.getBean(GetSentMailingsForOrgCommand.class);
		LocalDateTime startDate = LocalDateTime.of(2017, 05, 01, 0, 0, 0);
		LocalDateTime endDate = LocalDateTime.of(2018, 05, 01, 0, 0, 0);
		DateTimeRange dateTimeRange = new DateTimeRange(startDate, endDate);
		GetSentMailingsForOrgOptions options = new GetSentMailingsForOrgOptions(dateTimeRange);
		...
		ResponseContainer<GetSentMailingsForOrgResponse> responseContainer = command.readResponse(resultNode, options);
		GetSentMailingsForOrgResponse response = responseContainer.getResposne();
