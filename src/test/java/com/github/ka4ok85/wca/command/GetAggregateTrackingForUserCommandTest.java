...
public class GetAggregateTrackingForUserCommandTest {
	...
	private String defaultRequest = String.join(System.getProperty("line.separator"),
			...
			"<GetAggregateTrackingForUser>", "<DATE_START>02/01/2010 00:03:04</DATE_START>",
			"<DATE_END>05/01/2018 23:54:55</DATE_END>", "<TOP_DOMAIN>TRUE</TOP_DOMAIN>",
			"<INBOX_MONITORING>TRUE</INBOX_MONITORING>", "<PER_CLICK>TRUE</PER_CLICK>",
			"</GetAggregateTrackingForUser>", "</Body>", "</Envelope>");

	@Test(expected = NullPointerException.class)
	public void testBuildXmlDoesNotAcceptNullOptions() {
		GetAggregateTrackingForUserCommand command = new GetAggregateTrackingForUserCommand();
		GetAggregateTrackingForUserOptions options = null;
	...
	public void testBuildXmlDefaultRequest() {
		...
		GetAggregateTrackingForUserOptions options = new GetAggregateTrackingForUserOptions(range);
	...
	@Test
	public void testBuildXmlHonorsOptionalUser() {
		// get XML from command
		GetAggregateTrackingForUserCommand command = new GetAggregateTrackingForUserCommand();
		LocalDateTime startDate = LocalDateTime.of(2010, 02, 01, 0, 03, 04);
		LocalDateTime endDate = LocalDateTime.of(2018, 05, 01, 23, 54, 55);
		...
		options.setPerClick(true);
		options.setTopDomain(true);
		String optionalUser = "test user";
		options.setOptionalUser(optionalUser);
		...
		String controlString = defaultRequest.replace("</DATE_END>",
				"</DATE_END><OPTIONALUSER>" + optionalUser + "</OPTIONALUSER>");
		Source control = Input.fromString(controlString).build();
	...
	@Test
	public void testBuildXmlHonorsAutomated() {
		// get XML from command
		GetAggregateTrackingForUserCommand command = new GetAggregateTrackingForUserCommand();
		LocalDateTime startDate = LocalDateTime.of(2010, 02, 01, 0, 03, 04);
		LocalDateTime endDate = LocalDateTime.of(2018, 05, 01, 23, 54, 55);
		...
		// get control XML
		String controlString = defaultRequest.replace("</DATE_END>", "</DATE_END><AUTOMATED>TRUE</AUTOMATED>");
		Source control = Input.fromString(controlString).build();
	...
	@Test
	public void testBuildXmlHonorsCampaignActive() {
		// get XML from command
		GetAggregateTrackingForUserCommand command = new GetAggregateTrackingForUserCommand();
		LocalDateTime startDate = LocalDateTime.of(2010, 02, 01, 0, 03, 04);
		LocalDateTime endDate = LocalDateTime.of(2018, 05, 01, 23, 54, 55);
		...
		options.setPerClick(true);
		options.setTopDomain(true);
		options.setCampaignActive(true);
		...
		// get control XML
		String controlString = defaultRequest.replace("</DATE_END>",
				"</DATE_END><CAMPAIGN_ACTIVE>TRUE</CAMPAIGN_ACTIVE>");
		Source control = Input.fromString(controlString).build();
	...
	@Test
	public void testBuildXmlHonorsCampaignCancelled() {
		// get XML from command
		GetAggregateTrackingForUserCommand command = new GetAggregateTrackingForUserCommand();
		LocalDateTime startDate = LocalDateTime.of(2010, 02, 01, 0, 03, 04);
		LocalDateTime endDate = LocalDateTime.of(2018, 05, 01, 23, 54, 55);
		...
		options.setPerClick(true);
		options.setTopDomain(true);
		options.setCampaignCancelled(true);
		...
		// get control XML
		String controlString = defaultRequest.replace("</DATE_END>",
				"</DATE_END><CAMPAIGN_CANCELLED>TRUE</CAMPAIGN_CANCELLED>");
		Source control = Input.fromString(controlString).build();
	...
	@Test
	public void testBuildXmlHonorsCampaignCompleted() {
		// get XML from command
		GetAggregateTrackingForUserCommand command = new GetAggregateTrackingForUserCommand();
		LocalDateTime startDate = LocalDateTime.of(2010, 02, 01, 0, 03, 04);
		LocalDateTime endDate = LocalDateTime.of(2018, 05, 01, 23, 54, 55);
		...
		options.setPerClick(true);
		options.setTopDomain(true);
		options.setCampaignCompleted(true);
		...
		// get control XML
		String controlString = defaultRequest.replace("</DATE_END>",
				"</DATE_END><CAMPAIGN_COMPLETED>TRUE</CAMPAIGN_COMPLETED>");
		Source control = Input.fromString(controlString).build();
	...
	@Test
	public void testBuildXmlHonorsExcludeTestMailings() {
		// get XML from command
		GetAggregateTrackingForUserCommand command = new GetAggregateTrackingForUserCommand();
		LocalDateTime startDate = LocalDateTime.of(2010, 02, 01, 0, 03, 04);
		LocalDateTime endDate = LocalDateTime.of(2018, 05, 01, 23, 54, 55);
		...
		options.setPerClick(true);
		options.setTopDomain(true);
		options.setExcludeTestMailings(true);
		...
		// get control XML
		String controlString = defaultRequest.replace("</DATE_END>",
				"</DATE_END><EXCLUDE_TEST_MAILINGS>TRUE</EXCLUDE_TEST_MAILINGS>");
		Source control = Input.fromString(controlString).build();
	...
	@Test
	public void testBuildXmlHonorsOptinConfirmation() {
		// get XML from command
		GetAggregateTrackingForUserCommand command = new GetAggregateTrackingForUserCommand();
		LocalDateTime startDate = LocalDateTime.of(2010, 02, 01, 0, 03, 04);
		LocalDateTime endDate = LocalDateTime.of(2018, 05, 01, 23, 54, 55);
		...
		options.setPerClick(true);
		options.setTopDomain(true);
		options.setOptinConfirmation(true);
		...
		// get control XML
		String controlString = defaultRequest.replace("</DATE_END>",
				"</DATE_END><OPTIN_CONFIRMATION>TRUE</OPTIN_CONFIRMATION>");
		Source control = Input.fromString(controlString).build();
	...
	@Test
	public void testBuildXmlHonorsProfileConfirmation() {
		// get XML from command
		GetAggregateTrackingForUserCommand command = new GetAggregateTrackingForUserCommand();
		LocalDateTime startDate = LocalDateTime.of(2010, 02, 01, 0, 03, 04);
		LocalDateTime endDate = LocalDateTime.of(2018, 05, 01, 23, 54, 55);
		...
		options.setPerClick(true);
		options.setTopDomain(true);
		options.setProfileConfirmation(true);
		...
		// get control XML
		String controlString = defaultRequest.replace("</DATE_END>",
				"</DATE_END><PROFILE_CONFIRMATION>TRUE</PROFILE_CONFIRMATION>");
		Source control = Input.fromString(controlString).build();
	...
	@Test
	public void testBuildXmlHonorsScheduled() {
		// get XML from command
		GetAggregateTrackingForUserCommand command = new GetAggregateTrackingForUserCommand();
		LocalDateTime startDate = LocalDateTime.of(2010, 02, 01, 0, 03, 04);
		LocalDateTime endDate = LocalDateTime.of(2018, 05, 01, 23, 54, 55);
		...
		// get control XML
		String controlString = defaultRequest.replace("</DATE_END>", "</DATE_END><SCHEDULED>TRUE</SCHEDULED>");
		Source control = Input.fromString(controlString).build();
	...
	@Test
	public void testBuildXmlHonorsSent() {
		// get XML from command
		GetAggregateTrackingForUserCommand command = new GetAggregateTrackingForUserCommand();
		LocalDateTime startDate = LocalDateTime.of(2010, 02, 01, 0, 03, 04);
		LocalDateTime endDate = LocalDateTime.of(2018, 05, 01, 23, 54, 55);
		...
		// get control XML
		String controlString = defaultRequest.replace("</DATE_END>", "</DATE_END><SENT>TRUE</SENT>");
		Source control = Input.fromString(controlString).build();
	...
	@Test
	public void testBuildXmlHonorsSending() {
		// get XML from command
		GetAggregateTrackingForUserCommand command = new GetAggregateTrackingForUserCommand();
		LocalDateTime startDate = LocalDateTime.of(2010, 02, 01, 0, 03, 04);
		LocalDateTime endDate = LocalDateTime.of(2018, 05, 01, 23, 54, 55);
		...
		// get control XML
		String controlString = defaultRequest.replace("</DATE_END>", "</DATE_END><SENDING>TRUE</SENDING>");
		Source control = Input.fromString(controlString).build();
	...
	public void testReadResponse()
		...
		GetAggregateTrackingForUserCommand command = context.getBean(GetAggregateTrackingForUserCommand.class);
		LocalDateTime startDate = LocalDateTime.of(2010, 02, 01, 0, 03, 04);
		LocalDateTime endDate = LocalDateTime.of(2018, 05, 01, 23, 54, 55);
		DateTimeRange range = new DateTimeRange(startDate, endDate);
		GetAggregateTrackingForUserOptions options = new GetAggregateTrackingForUserOptions(range);
		...
		ResponseContainer<GetAggregateTrackingForUserResponse> responseContainer = command.readResponse(resultNode,
				options);
		GetAggregateTrackingForUserResponse response = responseContainer.getResposne();
