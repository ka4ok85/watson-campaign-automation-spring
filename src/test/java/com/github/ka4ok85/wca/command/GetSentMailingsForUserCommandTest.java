...
public class GetSentMailingsForUserCommandTest {
	...
	private String defaultRequest = String.join(System.getProperty("line.separator"),
			...
			"<GetSentMailingsForUser>", "<DATE_START>05/01/2017 00:00:00</DATE_START>",
			"<DATE_END>05/01/2018 00:00:00</DATE_END>", "</GetSentMailingsForUser>", "</Body>", "</Envelope>");

	public GetSentMailingsForUserCommandTest(String xmlNodeName, String methodName) {
	...
	public void testBuildXmlDoesNotAcceptNullOptions() {
		GetSentMailingsForUserCommand command = new GetSentMailingsForUserCommand();
		GetSentMailingsForUserOptions options = null;
