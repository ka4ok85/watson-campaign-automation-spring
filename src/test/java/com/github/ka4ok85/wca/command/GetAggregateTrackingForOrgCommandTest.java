...
public class GetAggregateTrackingForOrgCommandTest {
	...
	private String defaultRequest = String.join(System.getProperty("line.separator"),
			...
			"<GetAggregateTrackingForOrg>", "<DATE_START>02/01/2010 00:03:04</DATE_START>",
			"<DATE_END>05/01/2018 23:54:55</DATE_END>", "<TOP_DOMAIN>TRUE</TOP_DOMAIN>",
			"<INBOX_MONITORING>TRUE</INBOX_MONITORING>", "<PER_CLICK>TRUE</PER_CLICK>", "</GetAggregateTrackingForOrg>",
			"</Body>", "</Envelope>");
	...
	public void testBuildXmlDoesNotAcceptNullOptions() {
		...
		GetAggregateTrackingForOrgOptions options = null;
	...
	public void testReadResponse()
		...
		GetAggregateTrackingForOrgCommand command = context.getBean(GetAggregateTrackingForOrgCommand.class);
		LocalDateTime startDate = LocalDateTime.of(2010, 02, 01, 0, 03, 04);
		LocalDateTime endDate = LocalDateTime.of(2018, 05, 01, 23, 54, 55);
		DateTimeRange range = new DateTimeRange(startDate, endDate);
		GetAggregateTrackingForOrgOptions options = new GetAggregateTrackingForOrgOptions(range);
		...
		ResponseContainer<GetAggregateTrackingForOrgResponse> responseContainer = command.readResponse(resultNode,
				options);
		GetAggregateTrackingForOrgResponse response = responseContainer.getResposne();
